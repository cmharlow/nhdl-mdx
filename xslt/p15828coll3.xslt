...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="//oai_qdc:qualifieddc">
        <oai_qdc:qualifieddc xmlns:oai_qdc="http://worldcat.org/xmlschemas/qdc-1.0/" 
            ...
            <!-- will match specific templates that relevant for p15828coll3. -->
            <xsl:apply-templates />
            ...
            <dcterms:isPartOf>Brown Company Collection</dcterms:isPartOf>
            <xsl:call-template name="hub"/>
        </oai_qdc:qualifieddc>
    </xsl:template>
    
    <!-- This collection should ignore the contributor field. --> 
    <xsl:template match="dc:contributor" />
    
    <!-- This collection should ignore the creator field. --> 
    <xsl:template match="dc:creator" />
    
    <!-- This collection should ignore non-transcript description fields, so only map 1st. --> 
    ...
    <!-- This collection should ignore the extent field. --> 
